...
def depthFirstSearch(problem):
    ...
    while not open_list.isEmpty():
        n, directions = open_list.pop()

        if n not in visited:
            visited.append(n)
            if problem.isGoalState(n):
                return directions
            n_expand = problem.getSuccessors(n)
            for m in n_expand:
                coord, direc, cost = m
                new_directions = directions + [direc]
                open_list.push((coord, new_directions))
    ...
    while not open_list.isEmpty():
        ...
        if n not in visited:
            ...
            for m in n_expand:
                coord, direc, cost = m
                new_directions = directions + [direc]
                open_list.push((coord, new_directions), problem.getCostOfActions(new_directions))
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    visited = []
    open_list = util.PriorityQueue()
    open_list.push((problem.getStartState(), []), heuristic(problem.getStartState(), problem))
    ...
    while not open_list.isEmpty():
        ...
        if n not in visited:
            ...
            for m in n_expand:
                coord, direc, cost = m
                new_directions = directions + [direc]
                open_list.push((coord, new_directions), problem.getCostOfActions(new_directions) + heuristic(coord, problem))
