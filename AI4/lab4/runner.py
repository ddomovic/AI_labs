...
if __name__ == '__main__':
	...
	NN.addLayer(LinearLayer(input_size, 4))
	NN.addLayer(SigmoidLayer())
	NN.addLayer(LinearLayer(4, output_size))
	...
	plot_every = 10001 # Plot the actual vs estimated functions every this many iterations
